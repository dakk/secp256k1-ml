...
type keypair = buffer (* 96 *)
type seckey = buffer
type tweak = buffer
type bytes32 = buffer
type schnorrsig = buffer (* 64 *)

external xonly_pubkey_from_pubkey : Context.t -> pubkey -> xonly_pubkey -> bool = "caml_secp256k1_xonly_pubkey_from_pubkey" [@@noalloc]
external xonly_pubkey_parse : Context.t -> xonly_pubkey -> bytes32 -> bool = "caml_secp256k1_xonly_pubkey_parse" [@@noalloc]
external xonly_pubkey_serialize : Context.t -> bytes32 -> xonly_pubkey -> bool = "caml_secp256k1_xonly_pubkey_serialize" [@@noalloc]
external xonly_pubkey_cmp : xonly_pubkey -> xonly_pubkey -> int = "caml_secp256k1_xonly_pubkey_cmp" [@@noalloc]
external xonly_pubkey_tweak_add : Context.t -> pubkey -> xonly_pubkey -> tweak -> bool = "caml_secp256k1_xonly_pubkey_tweak_add" [@@noalloc]
external xonly_pubkey_tweak_add_check : Context.t -> bytes32 -> int -> xonly_pubkey -> tweak -> bool = "caml_secp256k1_xonly_pubkey_tweak_add_check" [@@noalloc]
external keypair_create : Context.t -> keypair -> seckey -> bool = "caml_secp256k1_keypair_create" [@@noalloc]
external keypair_pub : Context.t -> pubkey -> keypair -> bool = "caml_secp256k1_keypair_pub" [@@noalloc]
external keypair_sec : Context.t -> seckey -> keypair -> bool = "caml_secp256k1_keypair_sec" [@@noalloc]
external keypair_xonly_pub : Context.t -> xonly_pubkey -> keypair -> bool = "caml_secp256k1_keypair_xonly_pub" [@@noalloc]
external keypair_xonly_tweak_add : Context.t -> keypair -> tweak -> bool = "caml_secp256k1_keypair_xonly_tweak_add" [@@noalloc]
external raw_schnorrsig_sign : Context.t -> schnorrsig -> bytes32 -> keypair -> bytes32 option -> bool = "caml_secp256k1_schnorrsig_sign32" [@@noalloc]
external raw_schnorrsig_verify : Context.t -> schnorrsig -> buffer -> xonly_pubkey -> bool = "caml_secp256k1_schnorrsig_verify" [@@noalloc]
